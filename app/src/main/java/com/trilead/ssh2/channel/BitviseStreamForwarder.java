...
public class BitviseStreamForwarder extends Thread
{
   ...
   public BitviseStreamForwarder(
    ...
    public void run()
    {
        try
        {
            DataTransferGraph.GraphData reportedStats = new DataTransferGraph.GraphData();
    ...
    private void doStats(DataTransferGraph.GraphData reportedStats, int bytes_read)
    {
        // Psiphon Stats
        ...
        {
            reportedStats.setUp(bytes_read);
        }
        else
        {
           reportedStats.setDown(bytes_read);
        }
